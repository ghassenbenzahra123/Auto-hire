...
Autohire is cross platform application for job seekers to find the suitable jobs and Recruiters to find the best candidates. here is the Backend created with node js for this platform
